                ...
                @foreach($notes as $note)
                    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg mb-2">
                        ...
                        <div class="flex p-5 justify-between">
                            <x-nav-link :href="route('notes.edit', $note)" class="mr-3 hover:border-transparent dark:hover:border-transparent focus:border-transparent dark:focus:border-transparent">
